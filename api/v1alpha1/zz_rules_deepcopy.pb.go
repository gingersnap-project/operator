...
// DeepCopyInto supports using QuerySpec within kubernetes types, where deepcopy-gen is used.
func (in *QuerySpec) DeepCopyInto(out *QuerySpec) {
	p := proto.Clone(in).(*QuerySpec)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuerySpec. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new QuerySpec. Required by controller-gen.
func (in *QuerySpec) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
